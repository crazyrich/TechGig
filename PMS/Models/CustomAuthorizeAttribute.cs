    ...
    public class BasicHttpAuthorizeAttribute : System.Web.Http.AuthorizeAttribute
    {
        ...
        public override void OnAuthorization(System.Web.Http.Controllers.HttpActionContext actionContext)
        {
           // actionContext.Request.
            ...
            if (actionContext.ActionDescriptor.ActionName == "GetAllRisk")
            {
             //   string yes = "yes";
            }
        ...
        private bool TryGetPrincipal(string username, string password, out IPrincipal principal)
        {
            ...
            Customer person = new Customer();//AccountManagement.ApiLogin(username, password);
            var customeUser =  Membership.GetUser(username);
